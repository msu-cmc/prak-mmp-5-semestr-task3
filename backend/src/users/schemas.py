...
class UserRegister(BaseModel):
    ...
    password: str = Field(min_length=1, max_length=50, description="Пароль, от 1 до 50 знаков")
...
class UserUpdate(UserRegister):
    email: Union[EmailStr, None] = Field(
        description="Почта", default=None)
    password: Union[str, None] = Field(
        min_length=1, max_length=50,
        description="Пароль, от 1 до 50 знаков", default=None)
    fio: Union[str, None] = Field(
        description="ФИО", default=None)
    role: Union[str, None] = Field(
        description="Роль", default=None)
