import "./AkramFitTableComponentBIG.css";
...
const AkramFitTableComponentBIG = ({ columns = [], data = [] }) => {
...
export { AkramFitTableComponentBIG };
export default AkramFitTableComponentBIG;
